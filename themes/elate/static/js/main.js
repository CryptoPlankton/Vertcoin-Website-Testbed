...
function freenodeShow(e) {
  ...
  document.getElementById('chatbox').innerHTML = '<iframe style=width:98%;min-width:400px;height:600px src="https://web.archive.org/web/20170406233349/http://webchat.freenode.net/?channels=bitcoin-dev" />';
  cancelEvent(e);
}
...
function updateIssue(e) {
  ...
  var t = getEvent(e, 'target');
  t.href = 'https://web.archive.org/web/20170406233349/https://github.com/bitcoin-dot-org/bitcoin.org/issues/new?body=' + encodeURIComponent('Location: ' + window.location.href.toString() + "\n\n");
}
...
function updateSource(e) {
  ...
  t.href = 'https://web.archive.org/web/20170406233349/https://github.com/bitcoin-dot-org/bitcoin.org/edit/master/' + closer[0].getAttribute('data-sourcefile');
}
...
/*
     FILE ARCHIVED ON 23:33:49 Apr 06, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 09:52:50 Jun 27, 2018.
...
/*
playback timings (ms):
  LoadShardBlock: 112.546 (3)
  esindex: 0.006
  captures_list: 164.69
  CDXLines.iter: 13.777 (3)
  PetaboxLoader3.datanode: 107.268 (4)
  exclusion.robots: 0.208
  exclusion.robots.policy: 0.193
  RedisCDXSource: 1.906
  PetaboxLoader3.resolve: 247.736
  load_resource: 256.949
*/